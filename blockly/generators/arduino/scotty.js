...
goog.provide('Blockly.Arduino.scotty');
goog.require('Blockly.Arduino');

/*
Blockly.Arduino['scotty_forward'] = function(block) {
...
Blockly.Arduino['scotty_backward'] = function(block) {
...
Blockly.Arduino['scotty_right'] = function(block) {
...
Blockly.Arduino['scotty_left'] = function(block) {
...
Blockly.Arduino['scotty_stop'] = function(block) {
...
Blockly.Arduino['scotty_turn_go'] = function(block) {
...
Blockly.Arduino['scotty_polygone'] = function(block) {
...
Blockly.Arduino['scotty_cercle'] = function(block) {
...
Blockly.Arduino['scotty_ligne'] = function(block) {
  //-------------------------------------------------------------------
  Blockly.Arduino.addInclude('Scott', '#include <Scott.h>');
  Blockly.Arduino.addDeclaration('Scott', 'Scott robot(ORIGINAL);');
...
Blockly.Arduino['scotty_contact'] = function(block) {
  //-------------------------------------------------------------------
  Blockly.Arduino.addInclude('Scott', '#include <Scott.h>');
  Blockly.Arduino.addDeclaration('Scott', 'Scott robot(ORIGINAL);');
...
/*
Blockly.Arduino['scotty_lever_crayon'] = function(block) {
	//-------------------------------------------------------------------
    Blockly.Arduino.addInclude('Scott', '#include <Scott.h>');
    Blockly.Arduino.addDeclaration('Scott', 'Scott robot(ORIGINAL);');
...
Blockly.Arduino['scotty_descendre_crayon'] = function(block) {
	//-------------------------------------------------------------------
    Blockly.Arduino.addInclude('Scott', '#include <Scott.h>');
    Blockly.Arduino.addDeclaration('Scott', 'Scott robot(ORIGINAL);');
...
Blockly.Arduino['scotty_deplacement'] = function(block) {
...
Blockly.Arduino['scotty_rotation'] = function(block) {
...
Blockly.Arduino['scotty_crayon'] = function(block) {
  var dropdown_type = block.getFieldValue('TYPE');
  var code;
  //-------------------------------------------------------------------
  Blockly.Arduino.addInclude('Scott', '#include <Scott.h>');
